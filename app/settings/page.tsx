...
function SettingsContent() {
  ...
  const sectionsList: { id: SettingsSection; label: string; icon: any; description: string }[] = [
    ...
    { id: 'plan', label: 'Plan & Billing', icon: ArrowUpCircle, description: 'Current SubSync tier & plan management' },
        ...
        <div className="lg:col-span-3 rounded-2xl bg-[#0B0D0D] border border-[#1A1D1D] p-5 sm:p-7 space-y-6 min-h-[500px]">
          ...
          {activeSection === 'account' && (
            <section className="space-y-6">
              ...
              <div className="p-3.5 sm:p-4 rounded-xl bg-[#0B0D0D] border border-[#1A1D1D] hover:border-[#2A2E2E] transition-colors flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="pt-4 border-t border-[#1A1D1D]">
                <div className="p-3.5 sm:p-4 rounded-xl bg-[#0B0D0D] border border-[#D9363E]/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          {activeSection === 'plan' && (
            <section className="space-y-6">
              ...
              <div className="p-4 sm:p-5 rounded-xl bg-[#0B0D0D] border border-[#1A1D1D] space-y-4">
              ...
              <div className="p-4 sm:p-5 rounded-xl bg-[#0B0D0D] border border-[#1A1D1D] space-y-3">
          ...
          {activeSection === 'privacy' && (
            <section className="space-y-6">
              ...
              <div className="p-3.5 rounded-xl bg-[#0B0D0D] border border-[#1A1D1D] flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
