      ...
      <div className="flex items-center gap-3">
        {onMobileMenuToggle && (
          <button
            ...
            className="md:hidden p-2 rounded-xl text-env-body hover:text-env-heading hover:bg-env-button-sec transition-colors cursor-pointer"
          >
      ...
      <div className="flex items-center gap-2.5 md:gap-4">
        ...
        <div className="relative w-48 lg:w-64 hidden sm:block">
          ...
          <input
            ...
            className="w-full pl-9 pr-3.5 py-1.5 text-xs rounded-2xl border text-env-heading placeholder-env-muted focus:outline-none focus:border-indigo-500 transition-colors"
          />
        </div>
        ...
        {onOpenNewSubscriptionModal && (
          <button
            ...
            className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-md shadow-indigo-600/20 transition-all active:scale-95 cursor-pointer"
          >
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-2xl bg-env-button-sec hover:bg-env-button-sec-hover border border-env-main text-xs font-bold transition-all cursor-pointer"
        >
          {themeIcon}
        ...
        {/* Divider */}
        <div className="h-4 w-px bg-env-main" />
          ...
          {showMenu && (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2 text-xs font-semibold text-rose-400 hover:bg-rose-500/10 rounded-2xl transition-colors cursor-pointer"
              >
