...
export function SmartInsightCard({ subscriptions }: SmartInsightCardProps) {
  ...
  return (
    <div
      ...
      className="p-5 sm:p-6 rounded-[20px] bg-[#171A21] border border-[#2B313D] cursor-pointer transition-all duration-300 hover:border-[#3B4252] select-none"
    >
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3.5 min-w-0 flex-1">
          ...
          <div className="min-w-0 flex-1 flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
            <h3 className="text-[17px] font-semibold text-white tracking-tight shrink-0">
              Smart Insight
            </h3>

            {/* Collapsed One-Sentence Preview (Without Category Name) */}
            {!isOpen && (
              <span className="text-[14px] text-[#A1AAB8] truncate max-w-xl">
        ...
        {/* Animated Chevron ▼ / ▲ */}
        <div className="w-8 h-8 rounded-lg bg-[#1D222B] border border-[#2B313D] flex items-center justify-center shrink-0">
          <ChevronDown
      ...
      <div
        className={`grid transition-all duration-300 ease-in-out ${
          isOpen
            ? 'grid-rows-[1fr] opacity-100 mt-5 pt-5 border-t border-[#2B313D]/60'
      ...
      >
        <div className="overflow-hidden">
          <div className="pl-0 sm:pl-[50px] space-y-3 pt-0.5">
            ...
            <p className="text-[15px] text-[#A1AAB8] leading-[26px] max-w-3xl font-normal">
